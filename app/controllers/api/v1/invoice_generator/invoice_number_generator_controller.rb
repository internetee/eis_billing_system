class Api::V1::InvoiceGenerator::InvoiceNumberGeneratorController < Api::V1::InvoiceGenerator::BaseController
  ...
  def create
    ...
    return render  json: { 'message' => "Number create failed. #{invoice_number}", 'error' => invoice_number }, status: :not_implemented if invoice_number == 'out of range'

    render json: { 'message' => "Number created; #{invoice_number}", 'invoice_number' => invoice_number }, status: :created
  end
