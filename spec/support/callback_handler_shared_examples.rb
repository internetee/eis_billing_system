RSpec.shared_examples 'Callback handler' do
  #
  # def response
  ...
  # end
  #
  # it 'should get payment status' do
  #   allow_any_instance_of(Api::V1::CallbackHandler::CallbackHandlerController).to receive(:base_request).and_return response
  #
  # end
end
